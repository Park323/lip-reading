...
from lipreading.models.pytorch_backend.initialization import uniform_init_parameters
from lipreading.models.pytorch_backend.nets_utils import get_subsample, pad_list, to_device
