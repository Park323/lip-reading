...
These classes are based on the ones in lipreading.models.pytorch_backend.rnn.encoders,
...
from lipreading.models.e2e_asr_common import get_vgg2l_odim
from lipreading.models.pytorch_backend.nets_utils import make_pad_mask, to_device
